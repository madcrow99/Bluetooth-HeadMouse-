...
////////////////////////////////////
    if ( buttons[0].read() == LOW &&  buttons[1].read() == LOW &&  zoom == false) {
    zoom = true;
    button0Active = false;
  ...
  if ( buttons[0].read() == HIGH &&  buttons[1].read() == HIGH && zoom == true) {
  ...
  if ( buttons[0].read() == LOW && zoom == false) {
